document.getElementById('loginForm').addEventListener('submit', function(event) {
    ...
    // If form is valid, redirect to INVENTORY SCREEN (changed from dashboard.html)
    if (isValid) {
        window.location.href = 'C:/Users/Administrator/Documents/SIA/Inventory Management/src/components/pages/InventoryPage.jsx';
    }
});
